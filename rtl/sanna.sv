module sanna #(
	...
	// Weights must enter every row of the array without row-dependent delay.
	// During weight loading, keep the activation skew pipeline cleared so that
	// stale weight data cannot enter the first compute operation.
	genvar i;
	generate
